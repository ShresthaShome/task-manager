(function () {
  ...
  new MutationObserver((N) => {
    for (const W of N)
      if (W.type === "childList")
        for (const G of W.addedNodes)
          G.tagName === "LINK" && G.rel === "modulepreload" && r(G);
  }).observe(document, { childList: !0, subtree: !0 });
  function Z(N) {
    const W = {};
    return (
      N.integrity && (W.integrity = N.integrity),
      N.referrerPolicy && (W.referrerPolicy = N.referrerPolicy),
...
function mr() {
  ...
  function Z(r, N, W) {
    ...
    if (
      ...
      W = {};
      for (var il in N) il !== "key" && (W[il] = N[il]);
    } else W = N;
    return (
      (N = W.ref),
      { $$typeof: _, type: r, key: G, ref: N !== void 0 ? N : null, props: W }
    );
  }
...
var C0;
function gr() {
  return C0 || ((C0 = 1), (kf.exports = mr())), kf.exports;
}
var S = gr(),
  $f = { exports: {} },
  Q = {};
...
function Sr() {
  ...
  function Wt(s, z, Y, j, U, F) {
    return (
      (Y = F.ref),
      { $$typeof: _, type: s, key: z, ref: Y !== void 0 ? Y : null, props: F }
    );
  }
  function kt(s, z) {
  ...
  function Zl(s, z, Y, j, U) {
        ...
        case "object":
          switch (s.$$typeof) {
            ...
            case K:
              ...
              break;
            case k:
              return (V = s._init), Zl(V(s._payload), z, Y, j, U);
          }
      }
    if (V)
      return (
    ...
    if (wt(s))
      for (var al = 0; al < s.length; al++)
        (j = s[al]), (F = Gl + Mt(j, al)), (V += Zl(j, z, Y, F, U));
    else if (((al = D(s)), typeof al == "function"))
      for (s = al.call(s), al = 0; !(j = s.next()).done; )
        (j = j.value), (F = Gl + Mt(j, al++)), (V += Zl(j, z, Y, F, U));
    else if (F === "object") {
      if (typeof s.then == "function") return Zl(Ut(s), z, Y, j, U);
      throw (
        ((z = String(s)),
        Error(
  ...
  return (
    ...
    (Q.cloneElement = function (s, z, Y) {
      ...
      return Wt(s.type, U, void 0, void 0, F, j);
    }),
    ...
    (Q.createElement = function (s, z, Y) {
      var j,
        ...
        F = null;
      if (z != null)
        for (j in (z.key !== void 0 && (F = "" + z.key), z))
          Ql.call(z, j) &&
            j !== "key" &&
            j !== "__self" &&
            j !== "__source" &&
      ...
      if (s && s.defaultProps)
        for (j in ((V = s.defaultProps), V)) U[j] === void 0 && (U[j] = V[j]);
      return Wt(s, F, void 0, void 0, null, U);
    }),
    ...
    (Q.isValidElement = x),
    (Q.lazy = function (s) {
      return { $$typeof: k, _payload: { _status: -1, _result: s }, _init: X };
    }),
    (Q.memo = function (s, z) {
    ...
    Z0 ||
      ...
      (function (_) {
            ...
            l: for (var sl = 0, s = O.length, z = s >>> 1; sl < z; ) {
              ...
              if (0 > N(j, B))
                U < s && 0 > N(F, j)
                  ? ((O[sl] = F), (O[U] = B), (sl = U))
                  : ((O[sl] = j), (O[Y] = B), (sl = Y));
              else if (U < s && 0 > N(F, B)) (O[sl] = F), (O[U] = B), (sl = U);
              else break l;
            }
          }
          return X;
        ...
        function rt(O) {
          for (var X = Z(E); X !== null; ) {
            if (X.callback === null) r(E);
              ...
              r(E), (X.sortIndex = X.expirationTime), K(M, X);
            else break;
            X = Z(E);
          }
        }
                  ...
                  t: {
                    for (
                      ...
                      if (typeof sl == "function") {
                        ...
                        if (((O = _.unstable_now()), typeof s == "function")) {
        ...
        (_.unstable_IdlePriority = 5),
          ...
          (_.unstable_scheduleCallback = function (O, X, B) {
            var sl = _.unstable_now();
            switch (
            ...
            return (
              ...
              B > sl
                ...
                : ((O.sortIndex = s), K(M, O), yl || fl || ((yl = !0), Ut())),
              O
            );
          }),
          (_.unstable_shouldYield = x),
...
function Tr() {
  ...
  var G = _.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  function il(M, E) {
    if (M === "font") return "";
  ...
  return (
    ...
    (Yl.useFormState = function (M, E, k) {
      return G.H.useFormState(M, E, k);
    }),
...
function Ar() {
  ...
  return _(), (lc.exports = Tr()), lc.exports;
}
/**
 * @license React
...
` +
  ...
  var Xn = Object.prototype.hasOwnProperty,
    ...
    W0 = _.unstable_shouldYield,
    k0 = _.unstable_requestPaint,
    Et = _.unstable_now,
    $0 = _.unstable_getCurrentPriorityLevel,
    uc = _.unstable_ImmediatePriority,
    ac = _.unstable_UserBlockingPriority,
    Me = _.unstable_NormalPriority,
    F0 = _.unstable_LowPriority,
    ec = _.unstable_IdlePriority,
    P0 = _.log,
    I0 = _.unstable_setDisableYieldValue,
    _a = null,
    wl = null;
  function lv(l) {
  ...
  var kl = typeof Object.is == "function" ? Object.is : $v;
  function Ga(l, t) {
    if (kl(l, t)) return !0;
    if (
      typeof l != "object" ||
    ...
    for (a = 0; a < u.length; a++) {
      var e = u[a];
      if (!Xn.call(t, e) || !kl(l[e], t[e])) return !1;
    }
    return !0;
  }
  function Zc(l) {
  ...
  function ds(l) {
    ...
    function T(h, d, o) {
      ...
      if (typeof d == "object" && d !== null) {
        ...
        if (typeof d.then == "function") return T(h, We(d), o);
    ...
    function y(h, d, o, b) {
      ...
      if (typeof o == "object" && o !== null) {
        ...
        if (j(o) || Ql(o)) return R !== null ? null : g(h, d, o, b, null);
        if (typeof o.then == "function") return y(h, d, We(o), b);
    ...
    function m(h, d, o, b, R) {
      ...
      if (typeof b == "object" && b !== null) {
        ...
        if (j(b) || Ql(b)) return (h = h.get(o) || null), g(d, h, b, R, null);
        if (typeof b.then == "function") return m(h, d, o, We(b), R);
  ...
  var uh =
    ...
    ah = _.unstable_scheduleCallback,
    eh = _.unstable_NormalPriority,
    Ol = {
      $$typeof: fl,
      Consumer: null,
      Provider: null,
  ...
  function gs(l) {
    ...
    if (((au = 0), (Tl = el = L = null), (Ie = !1), (ka = 0), (da = null), t))
      throw Error(r(300));
    l === null ||
      Ml ||
  ...
  function _i(l) {
    ...
    (au = 0), (Tl = el = L = null), (sa = !1), (ka = ln = 0), (da = null);
  }
  function Kl() {
    var l = {
      memoizedState: null,
      ...
      if (
        ...
        try {
          var i = t.lastRenderedState,
            f = n(i, u);
          if (((e.hasEagerState = !0), (e.eagerState = f), kl(f, i)))
  ...
  function sd(l, t, u, a, e) {
    if (l !== null) {
      ...
      if (Ga(n, a) && l.ref === t.ref)
        if (((Ml = !1), (t.pendingProps = a = n), ki(l, e)))
  ...
  function Sd(l, t, u) {
    if (l !== null)
      if (l.memoizedProps !== t.pendingProps) Ml = !0;
        ...
        if (!ki(l, u) && (t.flags & 128) === 0) return (Ml = !1), yh(l, t, u);
        Ml = (l.flags & 131072) !== 0;
      }
    ...
    for (var e = t, n = !1; e !== null; ) {
      ...
      if (e.tag === 10) {
        ...
        if (((i = i.memoizedProps), i !== null)) {
          var f = e.type;
          kl(e.pendingProps.value, i.value) ||
            (l !== null ? l.push(f) : (l = [f]));
        }
  ...
  ot(Wc, "onAnimationEnd"),
    ot(kc, "onAnimationIteration"),
...
`
  ...
  var Kt = U.d;
  U.d = { f: wh, r: Wh, D: kh, C: $h, L: Fh, m: Ph, X: lr, S: Ih, M: tr };
  function wh() {
    var l = Kt.f(),
      t = bn();
    return l || t;
  ...
  function xn(l, t) {
    l.blockedOn === t &&
      ...
      wf ||
        ((wf = !0),
        _.unstable_scheduleCallback(_.unstable_NormalPriority, rr)));
  }
  var Yn = null;
  function Y0(l) {
    Yn !== l &&
  ...
  (Bn.prototype.render = Wf.prototype.render =
    function (l) {
    ...
    (Bn.prototype.unmount = Wf.prototype.unmount =
      function () {
...
function Dr() {
  ...
  return _(), (Ff.exports = zr()), Ff.exports;
}
var Or = Dr();
function Zu({ id: _, iTask: K, onDelete: Z, setTasks: r }) {
  const [N, W] = Jt.useState(!1),
    [G, il] = Jt.useState(K),
    M = (A) => {
      A.preventDefault(),
        !Object.values(G).some((D) => !D.trim()) && (W(!1), r(G));
    },
    E = () => {
      W(!0);
    },
    ...
    children: [
      S.jsx("div", {
        ...
        children: S.jsxs("div", {
          className: "single",
          children: [
            S.jsx("input", { type: "checkbox", id: `checkbox-${_}` }),
            S.jsxs("div", {
              onClick: k,
              style: {
                textDecoration:
            ...
            S.jsxs("div", {
              className: "sbuttons",
              children: [
                S.jsx("button", { disabled: N, onClick: E, children: "Edit" }),
...
function _r() {
  const _ = localStorage.getItem("theme") || "light",
    [K, Z] = Jt.useState(_);
  K === "dark" && document.documentElement.classList.add("dark");
  const r = () => {
    let N = K === "light" ? "dark" : "light";
...
function Mr() {
  ...
  const il = (A) => {
    ...
    M = (A) => {
      N((D) => D.filter((fl, yl) => yl !== A));
    },
    E = (A) => (D) => {
      N((fl) => fl.map((yl, pl) => (pl === A ? { ...D } : yl)));
    },
    k = () => {
      N((A) => {
        const D = A.filter(
